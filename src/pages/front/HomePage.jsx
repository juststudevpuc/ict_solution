        ...
        <section className="py-24 bg-slate-50 dark:bg-[#050B14] transition-colors duration-300">
          <div className="max-w-[1400px] mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="text-4xl md:text-5xl font-semibold text-slate-900 dark:text-white tracking-tight mb-6">
                Solutions made easy.
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* Card 1: Engineering */}
              <Card className="flex flex-col w-full min-h-[500px] bg-white dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] p-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] dark:shadow-none backdrop-blur-xl transition-all duration-500 group">
                <div className="relative w-full h-56 rounded-[2rem] overflow-hidden mb-8">
                ...
                <div className="px-6 pb-6 flex flex-col flex-grow">
                  <h3 className="text-2xl font-semibold text-slate-900 dark:text-white tracking-tight mb-6">
                  ...
                  <ul className="space-y-3 mb-10 flex-grow">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-4 text-slate-600 dark:text-slate-300 font-medium group/item cursor-default">
                        <div className="p-2 bg-slate-50 dark:bg-slate-800 rounded-lg group-hover/item:bg-[#0B1528] group-hover/item:text-white text-slate-400 transition-colors duration-300">
