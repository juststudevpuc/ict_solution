  ...
  departments: [
    {
      ...
      members: [
        { name: "Tha Channy", role: "Human Resource", image: "/api/placeholder/150/150" },
        { name: "Choeun Dalin", role: "Human Resource", image: "/api/placeholder/150/150" },
        { name: "Hout Soriya", role: "Human Resource", image: "/api/placeholder/150/150" },
      ],
    },
    {
      title: "Digital Marketing",
      members: [
        { name: "Vatha Chetkongkea", role: "Digital marketing", image: "/api/placeholder/150/150" },
        { name: "Reth annlina", role: "Digital marketing", image: "/api/placeholder/150/150" },
      ],
    },
    {
      title: "Video Editing",
      members: [
        { name: "Than Chantheary", role: "Video editor", image: "/api/placeholder/150/150" },
      ],
    },
    {
      title: "Mobile App Development",
      members: [
        { name: "Savean Raksmey", role: "Mobile App Developer", image: "/api/placeholder/150/150" },
      ],
    },
    {
      title: "UI/UX Design",
      members: [
        { name: "Phat Sopheaktra", role: "UI/UX Designer", image: "/api/placeholder/150/150" },
        { name: "Liv limey", role: "UI/UX Designer", image: "/api/placeholder/150/150" },
        { name: "Yin Prasethy Serey", role: "UI/UX Designer", image: "/api/placeholder/150/150" },
      ],
    },
    {
      title: "Web Development",
      members: [
        { name: "Seth Sopeara", role: "Full-Stack Developer", image: "/api/placeholder/150/150" },
        { name: "Uy sotheary", role: "Frontend Developer", image: "/api/placeholder/150/150" },
        { name: "Chhay Lymeng", role: "Tester", image: "/api/placeholder/150/150" },
      ],
    },
  ],
};
  ...
  <div className="flex flex-col rounded-[1.5rem] bg-slate-50/50 dark:bg-slate-800/20 p-5 border border-slate-200 dark:border-slate-800 transition-colors">
    ...
    <div className="flex flex-col gap-4">
      {department.members.map((member, idx) => (
        <div 
          key={idx} 
          className="group flex items-center gap-4 rounded-xl bg-white dark:bg-slate-800/60 p-3 shadow-sm border border-slate-200 dark:border-slate-700/60 hover:border-blue-300 dark:hover:border-blue-700/50 transition-all duration-300"
        >
          <img
            src={member.image}
            alt={member.name}
          ...
          />
          <div>
            <h5 className="font-semibold text-sm text-slate-900 dark:text-slate-100">{member.name}</h5>
            <p className="text-xs font-medium text-blue-600 dark:text-blue-400 mt-0.5">{member.role}</p>
          </div>
        </div>
      ))}
    </div>
